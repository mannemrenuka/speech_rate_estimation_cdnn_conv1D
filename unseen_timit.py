...
import keras
from scipy.stats import pearsonr
from keras.layers import Input,BatchNormalization, Conv2D, MaxPooling2D, GlobalAveragePooling2D, Dense, Flatten,TimeDistributed, GlobalAveragePooling1D,Dropout,MaxPooling1D,Reshape,Convolution1D
...
def subje(ext,fold):
        list_dir=ext
        l1=list_dir[0:159];l2=list_dir[159:316];l3=list_dir[316:473];l4=list_dir[473:631]
        if (fold==0):
               l=[l1,l2,l3,l4]
        elif (fold==1):
                l=[l2,l3,l4,l1]
...
def phoneme_rate(y,st,et):
      ...
      #print(phoneme_list)
      #print(time_phoneme_1)
      #print(time_phoneme_2)         
      sn=[]
...
Wav_Fs=8000
## Raw waveform
window_size=int(35*0.001*Wav_Fs) #500 window len
...
### CNN Spec
CNN1_filters= 16#8#256#256#64#32#128#64#128#256
CNN2_filters=0
...
for fold in range(4): #  no. of folds 
                                ...
                                for j in range(0,len(lsd[i])):
                                        ...
                                        for k in range(0,len(subfiles)):
                                                ...
                                                for m in range(0,len(se)-2):
                                                        ...
                                                        Y_train.append(phoneme_rate(subfiles[k][0:-4],se[m]/100 ,se[m+2]/100))
                                ...
                                for j in range(0,len(lsd[i])):
                                        ...
                                        for k in range(0,len(subfiles)):
                                                ...
                                                for m in range(0,len(se)-2):
                                                        ...
                                                        Y_val.append(phoneme_rate(subfiles[k][0:-4],se[m]/100 ,se[m+2]/100))
            else:
                                ...
                                for j in range(0,len(lsd[i])):
                                        ...
                                        for k in range(0,len(subfiles)):
                                                ...
                                                for m in range(0,len(se)-2):
                                                        ...
                                                        Y_test.append(phoneme_rate(subfiles[k][0:-4],se[m]/100 ,se[m+2]/100))
